...
<div class="row">
    <div class="col-md-12">
        <a href="{{ route('cliente.create') }}" data-bs-toggle='tooltip' title='Crear cliente'
            class="btn btn-primary mb-2" title="Crear Clientes">
                    ...
                    <tbody>
                        @foreach ($clientes as $cliente)
                            <tr>
                                ...
                                <td>
                                   <a data-bs-toggle="tooltip" title="Editar" href="{{route('cliente.edit', $cliente->id)}}"
                                        class="btn btn-outline-warning mt-3"><i class="fas fa-pencil-alt fa-lg"></i></a>
                                    <form action="{{route('detallefactura.destroy', $cliente->id)}}" class="d-inline"
                                        method="post">
                                        @csrf
