            ...
            <div class="card-body">
                ...
                <div class="card card-success mt-4">
                    ...
                    <form action="{{route('modopago.update', $modopago->id)}}" method="POST">
                        ...
                        <input type="text" id="nombre" name='nombre' value="{{$modopago->nombre}}" class="form-control @error('nombre') 
                            is-invalid
                        @enderror">
                        ...
                        <input type="text" name="descripcion" value="{{$modopago->descripcion}}" class="form-control @error('nombre') 
                            is-invalid
                        @enderror">
